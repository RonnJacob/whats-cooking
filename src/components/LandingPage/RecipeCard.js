...
export default class RecipeCard extends React.Component{
    ...
    render() {
        ...
        <div className="col-md-4 col-sm-6">
            <Link to={`/recipes/${this.props.popularRecipe.idMeal?this.props.popularRecipe.idMeal:this.props.popularRecipe._id}`}>
            ...
            <div>
                ...
                {this.props.loggedIn &&<Button variant="primary" onClick={this.handleShow}>
                    Delete
                </Button>}
